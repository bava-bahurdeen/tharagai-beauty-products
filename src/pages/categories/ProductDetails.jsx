        ...
        <section className="container mx-auto w-[1200px] h-[1340px] bg-white px-16 py-10  ">
          ...
          <div className="flex gap-5">
            <button
              ...
              className={
                toggle == 1 ? "border-b-2 border-black " : "border-none"
              }
            >
              Description
            </button>
            <button
              ...
              className={
                toggle == 2 ? "border-b-2 border-black " : "border-none"
              }
            >
            ...
            <button
              ...
              className={
                toggle == 3 ? "border-b-2 border-black " : "border-none"
              }
            >
              Reviews
            </button>
          ...
          <div>
            <p
              className={
                toggle === 1
                  ? "block font-[15px] mt-8 text-sm text-dark "
                  : "hidden"
              }
            >
          ...
          <div>
            <h1 className="font-lexend text-[40px] font-medium">
              Related products
            </h1>
            {product.map((items) => {
